...
void market::start()
{
    ...
    int Total_money_transfered = 0, Total_no_of_trade = 0, Total_share_traded = 0;
    mymap<int> indivitual_money_transfered;
    mymap<int> indivitual_buy_share_tranfered;
    mymap<int> indivitual_sell_share_tranfered;
